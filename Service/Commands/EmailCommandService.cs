...
namespace Service.Commands
{
    public class EmailCommandService : IEmailCommandService
    {
        ...
        private async Task SendEmailAsync(Customer customer, Mortgage mortgage)
        {
            ...
            {
                htmlContent = $"<div><strong>Dear {customer.FirstName} {customer.LastName},</strong><br>" +
                    $"<p>After reviewing your mortgage application, we regret to inform you that it has been declined.</p>" +
